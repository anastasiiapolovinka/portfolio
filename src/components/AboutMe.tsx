   ...
   return (
      <div className="text-slate-200 pt-6 lg:w-3/4 px-6 pb-10 bg-slate-800 lg:bg-transparent">
         <div className='flex flex-col lg:mt-40'>
            ...
            <p className='lg:text-2xl text-xl text-sky-600 font-medium mt-2'>A freelance software engineer with 2 years of experience in front-end web development.<br/> You can read about my experience below. Press the buttons!</p>
         </div>
